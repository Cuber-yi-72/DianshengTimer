...
const CUBE_TYPES = {
    ...
    SQUARE_CIRCLE_4: 'squareCircle4',
    SQUARE_CIRCLE_8: 'squareCircle8'
};
...
// ===== 二阶魔轮魔方常量 =====
const SQUARECIRCLE_CUBE = {
    FACE_SIZE_4: 8,    // 四分轮: 4扇形+4角块
    FACE_SIZE_8: 12,   // 八分轮: 8扇形+4角块
    FACE_COUNT: 6,
    FACE_KEYS: ['U', 'D', 'F', 'B', 'R', 'L']
};
...
const CUBE_COLORS = {
    ...
    RED: '#DD0000',
    ORANGE: '#FF8800',
    OCTAHEDRON_BLUE: 0x0066CC,
    OCTAHEDRON_ORANGE: 0xFF8800,
    OCTAHEDRON_PURPLE: 0x7E2F8E,
    OCTAHEDRON_WHITE: 0xFFFFFF,
    OCTAHEDRON_GRAY: 0x999999,
    OCTAHEDRON_YELLOW: 0xFFD700,
    OCTAHEDRON_GREEN: 0x00AA00,
    OCTAHEDRON_RED: 0xDD0000
};
